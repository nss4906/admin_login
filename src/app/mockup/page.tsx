...
import { Shirt, Download, Sparkles, Layers, Sliders, Image as ImageIcon, Check } from 'lucide-react';
    ...
    <div className="h-screen bg-[#090a0f] text-gray-100 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        ...
        <main className="flex-1 bg-[#090a0f] p-6 flex flex-col items-center justify-center relative">
          <div className="relative max-w-lg w-full aspect-[4/5] rounded-2xl overflow-hidden border border-panel-border shadow-2xl flex items-center justify-center" style={{ backgroundColor: templateColor }}>
            <img
              src={renderedMockup}
              alt="Rendered Mockup"
